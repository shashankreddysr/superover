...
function updateStrike()
{
    if(toss==1)
        ...
        document.getElementById("strike").value = "Pakistan Batting";
}
var count1=0;
var count2=0;
var w1count=0;
        ...
        else
        {
            ...
            else
            {
                if(team1score>team2score)
                    document.getElementById("result").textContent = "INDIA WINS!!!";
                else if(team2score>team1score)
                    document.getElementById("result").textContent = "PAKISTAN WINS!!!";
                else
